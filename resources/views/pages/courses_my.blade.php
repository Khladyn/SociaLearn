            ...
            <div class="p-1 pt-3 px-4 mb-4 bg-body-tertiary rounded-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('my_courses') }}">My Courses</a></li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row my-4">
                <div class="col-xl-2 col-lg-2 col-md-12 mb-3">
                    <div class="position-sticky" style="top: 7rem;">
                        <a href="{{ route('create_course') }}" class="btn btn-sm btn-dark"><i class="fas fa-plus"></i>&nbsp; Create Course</a>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="course-other-details text-muted mt-3">
                                        <small><i class="fas fa-chalkboard-teacher"></i>&nbsp; {{ $course->createdBy->first_name }} {{ $course->createdBy->last_name }} &nbsp; </small><br>                                        {{-- <small><i class="fas fa-star"></i> {{ $course->rating }} &nbsp; </small>  --}}
